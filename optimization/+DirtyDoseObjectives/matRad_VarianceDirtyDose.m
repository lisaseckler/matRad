classdef matRad_VarianceDirtyDose < DirtyDoseObjectives.matRad_DirtyDoseObjective
% matRad_VarianceDose Implements a homogenous dose distribution
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    methods
        function obj = matRad_VarianceDirtyDose(penalty)
